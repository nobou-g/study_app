...
1.トップページ
--------
<blockquote>•「Session List」に逐一最新のイベントが先頭にリストアップされるため、ユーザーは興味を持ったセミナーに参加可能<br>
            •サイドバーにチャットしたセミナーが表示されるため、ユーザーはすぐにレスポンスすることができる<br>
            •同じくサイドバーに主催しているセミナーが表示されるようになっている<br>
</blockquote>
